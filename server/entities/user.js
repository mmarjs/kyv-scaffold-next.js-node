...
const userSchema = new mongoose.Schema(
  {
    ...
    generatedInitialSignupToken: { type: Boolean, default: false },
    candidate: { type: String }, // Associated Candidate's slug Only if the user is type "user", which means they are associated with a
    fullname: { type: String },
    roles: [{ type: String }],
    wardReadable: { type: String },
    isdeleted: {
      type: Boolean,
      default: false,
    },
